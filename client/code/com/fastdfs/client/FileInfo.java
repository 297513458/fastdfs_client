...
public class FileInfo {
	 ...
	 * @param crc32
	 *            the crc32 signature
	 * @param source_ip_addr
	 *            the source storage ip address
	 */
	...
	public String toString() {
		...
		return "source_ip_addr = " + this.source_ip_addr + ", " + "file_size = " + this.file_size + ", "
				+ "create_timestamp = " + df.format(this.create_timestamp) + ", " + "crc32 = " + this.crc32;
	}
}
