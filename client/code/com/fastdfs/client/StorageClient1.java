...
public class StorageClient1 extends StorageClient {
	 ...
	 *            the master file id to generate the slave file
	 * @param prefix_name
	 ...
	 */
	public int append_file1(String appender_file_id, String local_filename) throws IOException, CustomException {
		String[] parts = new String[2];
	 ...
	 * @return 0 for success, != 0 for error (error no)
	 */
	public int append_file1(String appender_file_id, byte[] file_buff) throws IOException, CustomException {
		String[] parts = new String[2];
		this.errno = split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
			return this.errno;
	...
	public int modify_file1(String appender_file_id, long file_offset, byte[] file_buff, int buffer_offset,
			int buffer_length) throws IOException, CustomException {
		String[] parts = new String[2];
		this.errno = split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
			return this.errno;
	 ...
	 */
	public int delete_file1(String file_id) throws IOException, CustomException {
		String[] parts = new String[2];
	 ...
	 * @return 0 for success, none zero for fail (error code)
	 */
	public int truncate_file1(String appender_file_id) throws IOException, CustomException {
		String[] parts = new String[2];
		this.errno = split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
			return this.errno;
	 ...
	 * @return 0 for success, none zero for fail (error code)
	 */
	public int truncate_file1(String appender_file_id, long truncated_file_size) throws IOException, CustomException {
		String[] parts = new String[2];
		this.errno = split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
			return this.errno;
	 ...
	 */
	public byte[] download_file1(String file_id) throws IOException, CustomException {
	 ...
	 */
	public int download_file1(String file_id, String local_filename) throws IOException, CustomException {
		final long file_offset = 0;
		final long download_bytes = 0;
	 ...
	 *            the file id(including group name and filename)
	 * @param callback
	 *            the callback object, will call callback.recv() when data
	 *            arrive
	 * @return 0 success, return none zero errno if fail
	 */
	public int download_file1(String file_id, DownloadCallback callback) throws IOException, CustomException {
		final long file_offset = 0;
		final long download_bytes = 0;
	 ...
	 */
	public NameValuePair[] get_metadata1(String file_id) throws IOException, CustomException {
		String[] parts = new String[2];
		this.errno = split_file_id(file_id, parts);
		if (this.errno != 0) {
			return null;
	 ...
	 */
	public FileInfo query_file_info1(String file_id) throws IOException, CustomException {
		String[] parts = new String[2];
		this.errno = split_file_id(file_id, parts);
		if (this.errno != 0) {
			return null;
	 ...
	 * @return FileInfo object for success, return null for fail
	 */
	public FileInfo get_file_info1(String file_id) throws IOException, CustomException {
		String[] parts = new String[2];
		this.errno = split_file_id(file_id, parts);
		if (this.errno != 0) {
			return null;
