...
import com.fastdfs.client.ProtoCommon;
import com.fastdfs.client.ServerInfo;
...
public class TestClient1 {
	...
	public static void main(String args[]) {
		...
		try {
			...
			/*
			 * storageServer = tracker.getStoreStorage(trackerServer); if
			 * (storageServer == null) { System.out.println(
			 * "getStoreStorage fail, error code: " + tracker.getErrorCode());
			 * return; }
			 */
			...
			/*
			 * group_name = "group1"; file_id = client.upload_file1(group_name,
			...
			if (file_id == null) {
				...
				if ((errno = client.set_metadata1(file_id, meta_list,
						ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE)) == 0) {
			...
			if ((file_id = client.upload_file1(local_filename, null, meta_list)) != null) {
				...
				prefix_name = "-part2";
				file_ext_name = null;
				slave_file_id = client.upload_file1(master_file_id, prefix_name, local_filename, file_ext_name,
						meta_list);
				if (slave_file_id != null) {
					System.err.println("slave file_id: " + slave_file_id);
					System.err.println(client.get_file_info1(slave_file_id));
