...
public class TestAppender1 {
	...
	public static void main(String args[]) {
		...
		try {
			 ...
			 * client.upload_appender_file1(group_name, file_buff, "txt",
			 * meta_list);
			 */
			...
			appender_file_id = client.upload_appender_file1(null, f.length(), new UploadLocalFileSender(local_filename),
