...
import com.fastdfs.client.DownloadCallback;
...
public class TestLoad {
	public static ConcurrentLinkedQueue<String> file_ids;
	...
	public static class UploadThread extends Thread {
		...
		public void run() {
			...
			System.out.println("upload thread " + this.thread_index + " exit, total_upload_count: "
					+ TestLoad.total_upload_count + ", success_upload_count: " + TestLoad.success_upload_count
					+ ", total_download_count: " + TestLoad.total_download_count + ", success_download_count: "
	...
	public static class DownloadThread extends Thread {
		...
		public void run() {
			...
			System.out.println("download thread " + this.thread_index + " exit, total_download_count: "
					+ TestLoad.total_download_count + ", success_download_count: " + TestLoad.success_download_count
	...
	public static void main(String args[]) {
		...
		try {
			...
			file_ids = new ConcurrentLinkedQueue<String>();
